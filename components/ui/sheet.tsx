            ...
            >
                ...
                {showCloseButton && (
                    <SheetPrimitive.Close
                        ...
                        className="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-xl text-gray-600 dark:text-white/60 hover:bg-gray-100 dark:hover:bg-white/5"
                    >
                        <XIcon />
